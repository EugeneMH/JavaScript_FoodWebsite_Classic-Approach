...
function slider ({slidesSelector, sliderSelector, arrowPrev, arrowNext, totalCounter, currentCounter, sliderWrapper, slidesFieldSelector}) {
    let offset = 0;
    let slideIndex = 1;

    const slides = document.querySelectorAll(slidesSelector),
        slider = document.querySelector(sliderSelector),
        prev = document.querySelector(arrowPrev),
...
function tabs (tabsSelector, tabcontent, tabsParentSelector, activeClass) {
...
/* harmony import */ var _modules_menu_cards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu_cards */ "./js/modules/menu_cards.js");
